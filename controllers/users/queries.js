...
const insertPatient =
  "INSERT INTO public.patients(patient_id,user_id,dob) VALUES($1,$2,$3)";

const insertDoctor =
  "INSERT INTO public.doctors(doctor_id,user_id,hospital_id) VALUES($1,$2,$3)";

const insertHospital =
  "INSERT INTO public.hospitals(hospital_id,user_id,hospital_name) VALUES($1,$2,$3)";
